...
The data shows that private schools have the highest scores generally and community colleges have the lowest. Community colleges have the most varience in scores and private schools have less spread of scores. 
...
There is a significant difference between SAT scores across college types.
2. Which specific college types differ from each other?
There is the greatest difference in the scores between private and community colleges, whose scores tend to be lower than private schools. Private schools also out score public schools by about 74 points on average. 
3. How large are these differences?
The differences range between about 366 points on average between private and community colleges, and 74 points on average between private and public schools, which have the lowest difference in scores. 
...
Headline: Students at private colleges outscore students at public and community colleges on the SAT

Students attending private colleges tend to score the highest on the on the SAT and scoring 74 more points than pubic college students and 366 points more than community college students on average. 
