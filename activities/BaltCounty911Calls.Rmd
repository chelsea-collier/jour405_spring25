...
I would put the lines at around 17.5 and 6. 
...
The days identifiyed by the z scores are pretty similar to the cutoffs I created in task 3. 
...
I would discribe the day with the highest Z score as the day that was the biggest outlier from the mean. 
...
I would be interested in the increase in calls during the summer months, but I am most interested in the dip before school starts. I would also want to look at what ws happening in the local area during the most outlier days. I would want to know if there were any events that may correspond to an increase in calls. 
