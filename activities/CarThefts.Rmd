...
car_thefts %>% 
  ...
  geom_vline(aes(xintercept = mean(count)), color = "pink", linetype = "dashed", size = 1) +
...
The distribution a normal shape but is skewed to the right slightly. around 8 - 17 car thefts is within one standard deviation of the mean. 
