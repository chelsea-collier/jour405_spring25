...
```{r}
crimes <- read.csv("https://raw.githubusercontent.com/dwillis/jour405/refs/heads/main/data/md_annual_crime.csv") %>%  clean_names()
```
...
The data shows a downward trend in crime rates across the categories of property crime, total crimes and violent crimes. Across all three 2020 had the lowest rates. Conversely 1980 had the highest rate of total crime, 1979 had the higest property crime and 1992 had the highest violent rate. This makes sense to be due to the crack epidemic being in this period. 
