...
Yes because it explains signifigance, variance, error, takeaways ect in one model. It gives us a lot of information at once that can be used to draw educated conclusions.
...
points scored seems to impact wins the most, yards gained seems to impact the least.
...
It could be used to see where a teams strenths are and help to pedict how they will preform against different teams that have strengths in different areas.
