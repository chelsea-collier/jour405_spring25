...
Looking at the graph I dont see any strong linear tend between the FARMS percentage and math scores. There is a very weak positive trend.  I also see a lot of veritcal scatter that seems mostly uncorrelated w FARMS.
...
This model is worth using because it shows us that only about 2.5% of the math score variation is explained by farms percentage, meaning its not really predictive and that the weak positive slope is likely just chance. It helps us to know that it is probably more fruitful to look into other factors. 
...
Crooked Billet Elementary School outperformed expectations by more than 31 points, scoring 95.7% on math tests compared to predicted score of around 64.6%. Woodland Elementary, Upper Moreland Elementary, and Ridge Park Elementary each exceeded their expected scores by more than 24 points. Whitemarsh Elementary showed the largest negative residual, scoring just 26.1% compared to an expected 61%, a difference of nearly 35 points. Gulph Elementary, Lower Gwynedd, Rydal West, and Merion Elementary also scored between 26 and 31 points below
...
I would likely not write the story about the scores and meals. If the schoolboard member had made a public statement I would refute it and report that there is not a statisticly signifigant relationship between the two varibles. I would look into other factors that may be more perscriptive in my story. 
