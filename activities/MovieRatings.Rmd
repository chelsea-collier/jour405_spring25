...
The latter set has differences. There are less 5-star ratings than expected and more 4-star ratings than expected.There are less 3-star ratings than expected and more 1 and 2-star ratings than we expected. 
...
We reject the null hypothesis. The actual values are signifigantly different than the expected values. 
