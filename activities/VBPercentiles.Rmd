...
```{r}
team_aces %>% mutate(precentile = ntile(total_aces, 100))
```
...
Maryland is no. 17 in aces but in the 95th percentile. The 95th percentile sounds much better though, but just means that 95 percent of teams have equal to or less aces. 
