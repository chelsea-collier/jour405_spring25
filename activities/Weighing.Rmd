...
The weights range between 0.2298 and 3.0386.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

A weight of .23 means that the respondent is over represented in the sample so their vote is being counted as .23 of a vote. A weight of 3.04 means that the respondent is under represented so to correct for that their response is being counted as that of 3.04 people. 

3. Why might some respondents be weighted more heavily than others?

If they are part of a demographic group that is underepresented in the sample compared to the general population, or the population likely to vote. 
...
It helps us more accurately account for likelihood of turnout among less consistent voters which if we over estimate based off of even their responses could skew voting predictions. 
...
These differences suggest that people who rarely or never vote may have structural factors that prevent them from voting that do not prevent them from being servyed. It also shows that more non voters may have a desire to vote than actually do. But without weighting, their responses are over represented in the data and can skew results.  Weighting helps correct for this and better reflects true voting likelyhood.
