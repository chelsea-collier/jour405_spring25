...
Higher-educated individuals my be more likely to answer due to having jobs with more free time during surveying hours. Those with lower education levels may be harder to reach or less interested in participating.
...
College-Educated Americans Most Likely to Vote, Survey Suggests
...
Most of the categories didnt change much. Voters without a college education had the biggest change after weighting, and the 73.5% who said they would vote was dropped to 70.8$

2. Why might the weighted results be considered more accurate than the unweighted results?

Because the compensate for issues in the sample that may not exist in the voting population. 
...
It does because we can easily see if there was an increase or decrease and compare the differnces between groups without doing a lot of going back and forth between tables.
...
Survey data shows that education level plays a role in voting intentions. In unweighted and weighted numbers, individuals with higher education levels are more likely to say they plan to vote, with college graduates leading.

After applying weights the numbers shifts slightly. While college graduates still appear most likely to vote those with "High school or less" education intention to vote drops most noticeably when weighted.

This means polling results should not be taken at face value without understanding whether weights were applied. Accurate representation depends on how closely the sample reflects the general population even though this was a small change its hard to know how great a change will be prior to weighting.
...
1. **Why is it important for journalists to understand survey weighting when reporting on polls?**  
   Without understanding weighting, journalists risk misrepresenting public opinion by amplifying overrepresented voices in their reporting.

2. **How might the differences between weighted and unweighted results affect how you would report on this data?**  
   I’d be more cautious in claiming strong trends from unweighted data, and would clarify whether results are weighted in my reporting.
...
3. **What additional information would you want to know about how the weights were calculated before using this data in a news story?**  
   I’d want to know the population benchmarks used, which demographics were weighted (age, race, education, ect), and the methodology used to generate the weight
