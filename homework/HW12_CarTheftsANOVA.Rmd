...
It shows that thefts more than doubled during the spike year, and since the spike have decrease but still remain slightly less than double pre spike levels.
...
The chart shows a clear, sharp spike in theft rates throughout 2023 followed by a small decline and small peak shortly after, though thefts are currently on decline. 

Title: Declining car theft rates in PG County remain almost double what they were before 2023 spike
...
- **Null Hypothesis (H0)**: There is no significant difference in mean theft rates across the time periods.
- **Alternative Hypothesis (H1)**: There is a significant difference in mean theft rates between at least two time periods.
...
The one-way ANOVA test has an F-value of 218, which is very large. This means the variation between the time periods is much greater than the variation within each time period. That coupled with a low P-Val shows that the differences in average theft rates across the three periods are statistically significant. This means we can reject the null hypothesis and conclude that the spike in 2023 represents a real change, not just random variation.
...
Tukey's test confirms that theft rates during the spike year are significantly higher than both the pre and post-spike periods. It also shows that the post-spike period has higher theft rates than the pre-spike period and that this difference is statistically significant. 

Headline: Car thefts decline but remain high in Prince George’s County after 2023 spike  

Car thefts in Prince George’s County spiked in 2023 and new data shows they haven’t returned to pre-spike levels. A statistical analysis of monthly theft data finds that rates in 2024 remain significantly higher than they were before the spike, suggesting lasting consequences for public safety and law enforcement.
