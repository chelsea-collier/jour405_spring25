...
There are some meaningful differences between the observed and expected frequencies for grades A and C. There are more A's and fewer C's than expected. I think these differences are meaningful because they are more than a single digit difference.
...
Yes it is higher we reject the null hypothesis.
...
Grade A is higher than expected, grade B is slightly higher than expected, grade C Lower than expected, grade D Slightly higher than expected and grade F Lower than expected

I would be intersted in there being more A's and fewer C's than expected and if there is a possible skew toward higher grades. It would also be useful to examine if this pattern is consistent across departments or specific to one class.
