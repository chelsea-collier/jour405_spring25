...
The distribution is skewed to the right, meaning the songs in the dataset are more likely to have a high danceability score above the mean. The mean tells us that the arithmitic adverage of the dataset is slightly under .67. The standard deviation shows us that on adverage the "normal" amount that any one value deviates from the mean is around .16. I would want to do a story on if more explicit songs have are more likely to have higher or lower danceability scores. 
